...
import {
    collection, addDoc, getDocs, where, query, deleteDoc, updateDoc, doc
...
export default function Home() {
    ...
    return !authUser ? <Loader /> : (
        <main className="">
            <div className="bg-black text-white w-44 py-4 mt-10 rounded-lg 
            transition-transform hover:bg-black/[0.8] active:scale-90 flex items-center justify-center gap-2 font-medium shadow-md fixed bottom-5 right-5 cursor-pointer"
                onClick={signOut}>
                <GoSignOut size={19} />
                <span>Logout</span>
            </div>
            <div className="max-w-3xl mx-auto mt-10 p-8">
                <div className="bg-white -m-6 p-3 sticky top-0">
                    <div className="flex justify-center flex-col items-center">
                        <span className="text-7xl mb-12">📄&#9998;  </span>
                        <h1 className="text-3xl text-rose-950 md:text4xl  font-bold underline decoration-1">
                            Firebase TooDo App
                        </h1>
                    </div>
